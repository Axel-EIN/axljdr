...
$('.cacher, .voir').click(function(){
        ...
        if ($(this).hasClass('voir')) {
            ...
            $(this).removeClass('btn-tertiary-style').addClass('btn-primary-style').html('<i class="fa-solid fa-scroll fa-bounce" alt="Icône Voir" aria-hidden="true"></i>&nbsp;&nbsp;Voir les Episodes');
        }
